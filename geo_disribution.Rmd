...
Reverse geocoding the get the zip codes
...
download.file(map_url, "nyc_zip_map.geojson")

map_json <- geojson_read("./nyc_zip_map.geojson", what = "sp")
```

```{r}
nyc_zip_shp = rgdal::readOGR("/Users/amin/Desktop/untitled folder/cb_2017_us_zcta510_500k/cb_2017_us_zcta510_500k.shp")
