...
head(arrange(desc(pd_cd)), n = 1) %>% 
  ggplot(aes(aes(x = boro_nm, y = pd_cd, color = year))) +
  geom_point(alpha = 1, size = 9) +
>>>>>>> 0513bbdcdc29d6b761e4cfa5df66cbd2beab41c3
...
trend = ggplot(full, aes(x = boro_nm, y = off_rate, color = year)) +
 geom_point() + 
 theme(legend.position = "bottom") +
  labs(
    x = "Borough",
    y = "Number of offenses/Offense rate",
    caption = "NYC_Crime"
  )
ggplotly(trend)
