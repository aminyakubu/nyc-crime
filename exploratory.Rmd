...
We analyzed demographics information for victims of the sex-related, weapon-related and drug-related felonies. 
...
Click [here](https://github.com/aminyakubu/nyc-crime/blob/master/demographics.Rmd) to view the the code for the demographics table. 
