...
<<<<<<< HEAD
## Demographics Associated with the Three Felony Categories
=======
## Demographics Associated with the Three Felony Categories

For this exploratory analysis, we wanted to examine sociodemographics associated with each of the three types of felonies.
...
<center>
<br><img src = "images/demographics_table.png" alt="demographics" style="width:70%; border:1px solid"> <br>
</center>
...
socio_graph2
```
>>>>>>> 945f96c002487e7f9f7af4fb047ceed9f58f241c
...
##### Average length of crimes by brough and crime groups 
...
There seems to be a marked difference in the average length across boroughs and crime type. We also see that on average sex crimes have a longer average length of crime than drug and weapon related crimes. 

<br></br>

We visually investigated at the distribution of the length of time for the the crimes 
...
The density plot of the length of crimes shows that most of the values seemed to fall under "0," heavily skewing the data. We also noticed a high number of missing values. This skewness is important to assess for our formal analysis. 
As an exploration, we excluded missing values and only looked at observations for which length of time is greater than 0 to allow us to more clearly visualize and understand our data. The number of observations was still large and sufficient enough to observe patterns. 

The table below shows the averages after the exclusion.
```{r}
...
<br>
We are also visually examining the average length of time of reported felonies across boroughs. 
