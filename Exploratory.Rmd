...
First, we loaded information from the U.S. Census on total population in the individual NYC boroughs to calculate crime rates in each borough.
```{r}
...
Next, we plotted the overall crime rates over 2014-2017 for each borough.
```{r}
