...
crime_table = 
  ...
  aggregate('Time Difference (Days)', by = list(Borough), mean) %>% 
  summarise(avg_time_days = mean(time_diff2)) %>% 
...
<br>
Next, we looked at whether the length of time for the reported event/crime differed by borough visually. I examine length of reported events lasting no longer than a year.
